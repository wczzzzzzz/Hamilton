...
leg = Legend(fig[1, 2], [blue_line, black_line, invisible_line], ["Implicit Euler", "Exact Solution", "Δt=0.05"], position=(0.95, 0.95))

nᵢ = 10
record(fig, "./fig/一维/Implicit_1d.gif", 1:nₜ,framerate = 5) do i
    t = 0.0:Δt:i*Δt
