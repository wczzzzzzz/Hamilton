...
# filename = "msh/Non-uniform/Non-uniform_10.msh"
# filename = "msh/square/square_10.msh"
filename = "msh/square/square_irregular_8.msh"
gmsh.initialize()
gmsh.open(filename)
...
elements["Γ₃"] = getElements(nodes, entities["Γ³"], normal = true)
elements["Γ₄"] = getElements(nodes, entities["Γ⁴"], normal = true)
elements["Ω∩Γ₁"] = ApproxOperator.Seg2toTri3(elements["Γ₁"],elements["Ω"])
elements["Ω∩Γ₂"] = ApproxOperator.Seg2toTri3(elements["Γ₂"],elements["Ω"])
elements["Ω∩Γ₃"] = ApproxOperator.Seg2toTri3(elements["Γ₃"],elements["Ω"])
elements["Ω∩Γ₄"] = ApproxOperator.Seg2toTri3(elements["Γ₄"],elements["Ω"])
